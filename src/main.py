...
class splash_screen(tk.Frame):
	...
	def __init__(self, parent, controller):
		...
		ttk.Label(self, padding = "50", text = "Welcome to the Binance Supertrend Bot", font = ("Helvetica", 16)).grid(column = 0, row = 0)
...
class Log_in(tk.Frame):
	...
	def __init__(self, parent, controller):
		...
		ApiKey = tk.StringVar()
		key_entry = ttk.Entry(self, textvariable = ApiKey, width = 50).grid(column = 2, row = 2, padx = 20,pady = 8)
		# key_entry.focus()
